            ...
            <div className="container mx-auto text-center md:text-start">
                ...
                <div className="flex flex-col-reverse md:flex-row justify-between items-center md:items-start pb-5 md:pb-0 gap-8 md:gap-0">
                    <div>
                        ...
                        <h3 className='text-primary text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-black tracking-[1.93px] mb-5'>দ্বাদশ জাতীয় সংসদ নির্বাচন ২০২৪</h3>
                        <span className='block text-sm font-normal text-gray1 mb-8 md:mb-16'>নির্বাচনের সর্বশেষ দেখতে চোখ রাখুন কালেরকণ্ঠে, আংশিক নয় পুরো সত্যি </span>
                        <div className='grid grid-cols-3 gap-4 lg:gap-16'>
                            {
                                electionDate.map((data, i) => (
                                    <div key={i} className='text-primary-light bg-primary h-10 md:h-20 rounded-xl font-normal text-lg md:text-3xl flex justify-center items-center'>{data}</div>
                                ))
                            }
                        </div>
                    </div>
